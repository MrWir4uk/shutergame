...
start_screen = True
start_text = font2.render(f"PRESS ANT KEY TO START", True, (255,255,255))
restart_text = font2.render(f"PRESS R KEY TO RESTART", True, (255,255,255))
...
while run:
    ...
    if start_screen:
        window.blit(start_text,(500,300))
    else:
